...
export default function Footer() {
  ...
  <motion.a
    ...
    href="https://www.linkedin.com/"   // ✅ Add LinkedIn Link here
    target="_blank"
  ...
  <motion.a
    whileHover={{ y: -6, boxShadow: "0 0 25px rgba(110,69,226,0.6)" }}
    transition={{ type: "spring", stiffness: 280 }}
    href="https://twitter.com/"   // ✅ Add Twitter Link here
    target="_blank"
    rel="noopener noreferrer"
    className="w-10 h-10 flex items-center justify-center rounded-full 
    bg-gradient-to-r from-[#6E45E2] to-[#B34BF8] text-white cursor-pointer shadow-md"
  ...
  <motion.a
    whileHover={{ y: -6, boxShadow: "0 0 25px rgba(110,69,226,0.6)" }}
    transition={{ type: "spring", stiffness: 280 }}
    href="https://github.com/"   // ✅ Add GitHub Link here
    target="_blank"
    rel="noopener noreferrer"
    className="w-10 h-10 flex items-center justify-center rounded-full 
    bg-gradient-to-r from-[#6E45E2] to-[#B34BF8] text-white cursor-pointer shadow-md"
  ...
  <motion.a
    whileHover={{ y: -6, boxShadow: "0 0 25px rgba(110,69,226,0.6)" }}
    transition={{ type: "spring", stiffness: 280 }}
    href="https://facebook.com/"   // ✅ Add Facebook Link here
    target="_blank"
    rel="noopener noreferrer"
    className="w-10 h-10 flex items-center justify-center rounded-full 
    bg-gradient-to-r from-[#6E45E2] to-[#B34BF8] text-white cursor-pointer shadow-md"
...
<div>
  ...
  <span className="leading-relaxed">
    satyabama complex, 301, KPHB Main Rd, opposite sai baba temple,Bhagya Nagar Colony,Hyderabad, Telangana 500072
  </span>
</li>
    ...
    <li className="flex items-center gap-3">
      ...
      >
        ...
        <div className="flex justify-center gap-6 mt-3">
          ...
          <a href="#" className="hover:text-[#6E45E2]">Terms of Service</a>
          <a href="#" className="hover:text-[#6E45E2]">Cookie Policy</a>
        </div>
      </motion.div>
    </motion.footer>
  );
